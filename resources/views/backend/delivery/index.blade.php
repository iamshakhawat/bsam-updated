...
@section('main-content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary float-left">Delivery Man List</h6>
                        ...
                        <tbody>
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td><span class="badge badge-pill badge-primary">Delivery Man</span></td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                            ...
                                            @if ($user->delivery_status == 'Confirm')
                                                <span class="badge badge-primary">Confirm</span>
                                            @elseif($user->delivery_status == 'Picked-Up')
                                                <span class="badge badge-info">Picked-Up</span>
                                            @elseif($user->delivery_status == 'Out of Delivery')
